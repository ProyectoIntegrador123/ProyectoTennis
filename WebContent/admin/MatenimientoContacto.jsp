...
<head>
  ...
  <title>Mantenimiento de Contacto</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div class="container-fluid" style="margin-top:45px ;margin-left:70px ; margin-right: 70px">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Matenimiento de Contacto</h1>
        <p class="mb-4">Aqui podemos Agregar ,Actualizar o Eliminar los Contactos  </a>.</p>

        <form class="user">
          <div class="form-group row">
              <div class="col-sm-6  mb-3 mb-sm-0">
                <input type="text" class="form-control form-control-user" placeholder="Detalle">
              </div>
              <div class="col-sm-6  mb-3 mb-sm-0">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4"  >
                <a href="#" class="btn btn-danger btn-icon-split" style= "padding: 10px 25px 10px 25px" >
                    <span class="text">Eliminar Contacto</span>
                  </a>
            </div>
            <div class="col-sm-4">
                <a href="#" class="btn btn-warning btn-icon-split"  style= "padding: 10px 25px 10px 25px" >
                    <span class="text">Actualizar Contacto</span>
                  </a>
            </div>
          </div>
