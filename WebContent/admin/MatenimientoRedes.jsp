...
<head>
  ...
  <title>Mantenimiento Redes</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div class="container-fluid" style="margin-top:45px ;margin-left:70px ; margin-right: 70px">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Matenimiento de Redes</h1>
        <p class="mb-4">Aqui podemos Agregar ,Actualizar o Eliminar de las Redes  </a>.</p>
